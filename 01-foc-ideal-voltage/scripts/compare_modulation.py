...
=====================
A tool to compare the waveform differences caused by turning midpoint
modulation and dq-axis decoupling control ON/OFF.
...
CLI arguments:
    --exe   PATH   path to the executable (default: auto-search the built BrushlessDCMotor)
