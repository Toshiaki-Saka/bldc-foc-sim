...
=====================
Tool for comparing the waveform difference from turning midpoint (min-max)
...
iq / Te / omega / id waveforms, letting you visually confirm the effect of each
feature.
...
CLI arguments:
    --exe   PATH   path to the executable (default: auto-detect pre-built BrushlessDCMotor)
...
def run_simulation(exe, span, iq_ref, tload, midpoint, decoupling):
    ...
    # Also capture the RESULT line (at the end of stdout)
    summary = ""
