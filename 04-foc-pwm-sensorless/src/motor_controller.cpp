// =============================================================================
//  motor_controller.cpp  —  FOC controller / PI controller — implementation
// -----------------------------------------------------------------------------
//  Project : bldc-foc-sim / 04-foc-pwm-sensorless
//  Transforms the measured currents into the dq axes and computes the voltage
//  command with PI control. Optionally applies the decoupling feed-forward
